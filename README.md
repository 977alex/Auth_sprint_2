Вроде все поправил
ЗЫ хочу успеть сдать 7ой принт

Здравствуйте. Все мои коллеги взяли академический отпуск.Я остался один. 
Но мы сделали проект. Прошу проверить и допустить дальше.
https://github.com/977alex/Auth_sprint_1

Описание API: /docs/swagger_auth_api.yaml
Схема базы данных: /schema/db_schema.sql
ORM модели: /flask_app/db_models.py
